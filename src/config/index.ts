...
export const SITE_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary: "A tattoo shop website that showcases the work of the artist and provides shop details.",
    ...
    {
      name: 'BMI Calculator',
      summary: 'A BMI calculator that allows users to calculate their BMI and get a personalized recommendation.',
